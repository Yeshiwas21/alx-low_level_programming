...
### Introduction
This repository is a Shell Project. The school project consisted in writing a shell like sh (Bourne Shell)  , in **C**, using a limited number of standard library functions, So Instead we used ower own function that we rewrited over the past three month.
...
`` git clone https://github.com/Yeshiwas21/simple_shell.git ``
